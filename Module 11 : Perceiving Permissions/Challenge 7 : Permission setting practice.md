...
This challenge requires us to change the executable permission of a file by using 'chmod', instead of tweaking pre-existing permissions we just had to specify the new
permissions in this one.

### Solve
**Flag:** 'pwn.college{oSoQOJUqDfWnUZMgSh7GHwxlzKn.QXzETO0wSOxkjNzEzW}'

We had to use the 'chmod' command to change file permissions as per the round's demand every time to advance to the next round. Just that instead of tweaking pre-existing
permissions we had to set new permissions every time using '=' instead of '+' or '-'. When all the rounds were over, we had to make '/flag' readable by using : 
'chmod ugo+r /flag'. Then we simply had to read the flag from that.
...
pwn.college{kdey_2-WiS5aRXvaWbw56MLZ4fn.QXwEjN0wSOxkjNzEzW}
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=rwx,g=rw,o=- /challenge/pwn
You set the correct permissions!
Round 3 of 8!
...
* the world does have write permissions
* the world does have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod ug=r,o=wx /challenge/pwn
You set the correct permissions!
Round 4 of 8!
...
* the world does have write permissions
- the world doesn't have execute permissions
hacker@permissions~permissions-setting-practice:~$ chmod u=-,g=rwx,o=w /challenge/pwn
You set the correct permissions!
Round 8 of 8!
...
pwn.college{oSoQOJUqDfWnUZMgSh7GHwxlzKn.QXzETO0wSOxkjNzEzW}
```

### What I Learnt
I Learnt how we can set the permissions of a file by using '=' in chmod. Apart from that just practicing of old concepts.
### References 
None. 
